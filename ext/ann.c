...
zend_class_entry *ann_neuron_ce;
...
zend_class_entry *ann_synapse_ce;
...
#ifndef ZEPHIR_RELEASE
static PHP_MSHUTDOWN_FUNCTION(ann)
{
 ...
 */
static void php_zephir_init_globals(zend_ann_globals *zephir_globals TSRMLS_DC)
{
...
static PHP_RINIT_FUNCTION(ann)
{

	zend_ann_globals *zephir_globals_ptr = ZEPHIR_VGLOBAL;
...
static PHP_RSHUTDOWN_FUNCTION(ann)
{
...
static PHP_MINFO_FUNCTION(ann)
{
	php_info_print_box_start(0);
	php_printf("%s", PHP_ANN_DESCRIPTION);
	php_info_print_box_end();

	php_info_print_table_start();
	php_info_print_table_header(2, PHP_ANN_NAME, "enabled");
	php_info_print_table_row(2, "Author", PHP_ANN_AUTHOR);
	php_info_print_table_row(2, "Version", PHP_ANN_VERSION);
	php_info_print_table_row(2, "Powered by Zephir", "Version " PHP_ANN_ZEPVERSION);
	php_info_print_table_end();


}

static PHP_GINIT_FUNCTION(ann)
{
	php_zephir_init_globals(ann_globals TSRMLS_CC);
}

static PHP_GSHUTDOWN_FUNCTION(ann)
{

}

zend_module_entry ann_module_entry = {
